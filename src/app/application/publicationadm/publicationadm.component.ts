...
@Component({
  selector: 'app-publicationadm',
  templateUrl: './publicationadm.component.html',
  styleUrls: ['./publicationadm.component.css']
})
export class PublicationadmComponent implements OnInit {
  idp : string;
  pub : Publication;
  Users:User[];
