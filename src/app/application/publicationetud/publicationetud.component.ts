...
@Component({
  selector: 'app-publicationetud',
  templateUrl: './publicationetud.component.html',
  styleUrls: ['./publicationetud.component.css']
})
export class PublicationetudComponent implements OnInit {
  idp : string;
  pub : Publication;
  Users:User[];
